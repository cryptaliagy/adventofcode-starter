...
/// let microduration = Duration::from_nanos(1005);
/// let nanoduration = Duration::from_nanos(185);
///
/// assert_eq!("1.005 s", &format_duration(duration));
/// assert_eq!("1.005 ms", &format_duration(milliduration));
/// assert_eq!("1.005 μs", &format_duration(microduration));
/// assert_eq!("185 ns", &format_duration(nanoduration));
/// ```
